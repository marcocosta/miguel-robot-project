...
class CameraManager:
    ...
    - Other workers ask this class for latest_frame copies.
    - This prevents stale queue reads and thread competition.
    """
    ...
    def save_latest_frame(self, prefix="v7_scene") -> Optional[Path]:
        snap = self.get_latest_frame(require_fresh=True)
    ...
    def get_face_state(self, max_age_seconds=1.0) -> dict:
        with self.lock:
