...
class CameraManager:
    ...
    def _get_newest_raw_msg(self):
        ...
        try:
            ...
            # Do not use blocking get() inside the camera owner thread.
            # The output queue is maxSize=1/blocking=False, so tryGet/tryGetAll
            # should be enough. Blocking get can hang shutdown and trigger DepthAI aborts.
            return latest
