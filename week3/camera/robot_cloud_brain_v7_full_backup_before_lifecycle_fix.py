...
def create_camera_manager():
    """
    Create DepthAI camera pipeline and CameraManager.

    Uses latest-frame queue behavior:
    ...
    manager = CameraManager(camera_queue, max_frame_age_seconds=0.75)
...
def run_v7_full():
    ...
    try:
        pipeline, camera_manager = create_camera_manager()
